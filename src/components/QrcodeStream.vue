...
import spawnWorker from "vue-qrcode-reader/src/worker/jsqr.js";
    ...
    init() {
      const promise = (async () => {
        ...
        if (this.camera === "off") {
          ...
          // stream.
          if (this.destroyed) {
            // Cette méthode dans la librairie fait complètement crasher l'application sur mobile mais pas sur PC
